...
const MainPage = () => {
    return (
        <div className='mx-7 my-5 flex flex-col h-[100%]'>
            ...
            <div>
                <h1 className=' text-lg font-bold'>Frontend Engineer</h1>
            </div>

            <main>
            <div className='flex flex-col text-center items-center justify-center mt-[220px]'>
                <h1 className=' text-4xl font-bold'>Hi 👋, I'm Peace </h1>
                <h2 className='text-lg'>I build responsive and well optimized software products.</h2>
            </div>
            <div className='flex flex-col items-center justify-center mt-5 mb-[100px]'>
            ...
            <footer className=' fixed left-0 bottom-2 w-[100%] text-center py-2'>
